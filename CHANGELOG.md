...
- Explicit YouTube URLs prefer exact-video extraction; when blocked, SoundCloud fallback is allowed only after strict artist/title/duration validation and never through a blind search-result download.
